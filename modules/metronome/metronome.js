...
//    }).data("id", "weight");
    ...
    return {
        ...
        make_input: function(el) {
        	$("<div />", {
        		html: 	"<input class='metr_input' type='text' id='tempo' value='100' />" +
						"<br><button class='btn' id='startstop'>start</button>"
        	}).appendTo(el);
			...
			$('#startstop').click(function() {
				...
				if ($(this).html() === "start") {
					...
					m.start(tempo, 10000000000000000000000);//??
				} else {
					$(this).html("start");
					m.stop();
				}
