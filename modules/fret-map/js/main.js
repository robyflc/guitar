...
$(function() {
	...
	function changeNotes() {
		...
		if (($('ul.select-root.minor-blues li.show-root-e.active').length) && ($('ul.select-scale.e li.scale-minor-blues.active').length)) {
			...
			$('.note-e, .note-g, .note-a, .note-as, .note-b, .note-d').addClass('on');
		}
		// F
			...
			$('.note-f, .note-gs, .note-as, .note-b, .note-c, .note-ds').addClass('on');
		}
		// F#
		...
		// G
			...
			$('.note-g, .note-f, .note-as, .note-c, .note-cs, .note-d').addClass('on');
		}
		// G#
		...
		// Bb
			...
			$('.note-as').addClass('root');			
			$('.note-as, .note-e, .note-f, .note-gs, .note-ds, .note-cs').addClass('on');
		}
		// B
		...
		// C
			...
			$('.note-c, .note-ds, .note-f, .note-fs, .note-g, .note-as').addClass('on');
		}
		// C#
		...
		// F
			...
			$('.note-f').addClass('root');
			$('.note-f, .note-gs, .note-as, .note-c, .note-ds').addClass('on');
		}
		// F#
		...
		// G
			...
			$('.note-g').addClass('root');
			$('.note-g, .note-f, .note-as, .note-c, .note-d').addClass('on');
		}
		// G#
		...
		// Bb
			...
			$('.note-as').addClass('root');			
			$('.note-as, .note-f, .note-gs, .note-ds, .note-cs').addClass('on');
		}
		// B
		...
		// C
			...
			$('.note-c').addClass('root');		
			$('.note-c, .note-f, .note-g, .note-as, .note-as, .note-ds').addClass('on');
		}
		// C#
		...
		// D#
			...
			$('.note-ds').addClass('root');			
			$('.note-ds, .note-fs, .note-gs, .note-as, .note-as, .note-cs').addClass('on');
		}
		...
		// F
			...
			$('.note-f').addClass('root');
			$('.note-f, .note-g, .note-a, .note-as, .note-c, .note-d, .note-e').addClass('on');
		}
		// F#
		...
		// G#
			...
			$('.note-gs').addClass('root');				
			$('.note-gs, .note-as, .note-c, .note-cs, .note-ds, .note-f, .note-g').addClass('on');
		}
		// A
		...
		// Bb
			...
			$('.note-as').addClass('root');			
			$('.note-as, .note-c, .note-d, .note-ds, .note-f, .note-g, .note-a').addClass('on');
		}
		// B
		else if (($('ul.select-root.major li.show-root-b.active').length) && ($('ul.select-scale.b li.scale-major.active').length)) {
			$('.note-b').addClass('root');		
			$('.note-b, .note-cs, .note-ds, .note-e, .note-fs, .note-gs, .note-as').addClass('on');
		}
		// C
		...
		// C#
			...
			$('.note-cs').addClass('root');			
			$('.note-cs, .note-ds, .note-f, .note-fs, .note-gs, .note-as, .note-c').addClass('on');
		}
		// D
		...
		// D#
			...
			$('.note-ds').addClass('root');			
			$('.note-ds, .note-f, .note-g, .note-gs, .note-as, .note-c, .note-d').addClass('on');
		}
		...
		// F
			...
			$('.note-f').addClass('root');
			$('.note-f, .note-g, .note-gs, .note-as, .note-c, .note-d, .note-e').addClass('on');
		}
		// F#
		...
		// G
			...
			$('.note-g').addClass('root');
			$('.note-g, .note-a, .note-as, .note-c, .note-d, .note-e, .note-fs').addClass('on');
		}
		// G#
		else if (($('ul.select-root.jazz-minor li.show-root-gs.active').length) && ($('ul.select-scale.gs li.scale-jazz-minor.active').length)) {
			$('.note-gs').addClass('root');				
			$('.note-gs, .note-as, .note-b, .note-cs, .note-ds, .note-f, .note-g').addClass('on');
		}
		// A
		...
		// Bb
			...
			$('.note-as').addClass('root');			
			$('.note-as, .note-c, .note-cs, .note-ds, .note-f, .note-g, .note-a').addClass('on');
		}
		// B
		else if (($('ul.select-root.jazz-minor li.show-root-b.active').length) && ($('ul.select-scale.b li.scale-jazz-minor.active').length)) {
			$('.note-b').addClass('root');		
			$('.note-b, .note-cs, .note-d, .note-e, .note-fs, .note-gs, .note-as').addClass('on');
		}
		// C
		...
		// C#
			...
			$('.note-cs').addClass('root');			
			$('.note-cs, .note-ds, .note-e, .note-fs, .note-gs, .note-as, .note-c').addClass('on');
		}
		// D
		...
		// D#
			...
			$('.note-ds').addClass('root');			
			$('.note-ds, .note-f, .note-fs, .note-gs, .note-as, .note-c, .note-d').addClass('on');
		}
		...
		// F
			...
			$('.note-f').addClass('root');
			$('.note-f, .note-g, .note-gs, .note-as, .note-c, .note-cs, .note-ds').addClass('on');
		}
		// F#
		...
		// G
			...
			$('.note-g').addClass('root');
			$('.note-g, .note-a, .note-as, .note-c, .note-d, .note-ds, .note-f').addClass('on');
		}
		// G#
			...
			$('.note-gs').addClass('root');				
			$('.note-gs, .note-as, .note-b, .note-cs, .note-ds, .note-e, .note-fs').addClass('on');
		}
		// A
		...
		// Bb
			...
			$('.note-as').addClass('root');			
			$('.note-as, .note-c, .note-cs, .note-ds, .note-f, .note-fs, .note-gs').addClass('on');
		}
		// B
		...
		// C
			...
			$('.note-c').addClass('root');		
			$('.note-c, .note-d, .note-ds, .note-f, .note-g, .note-gs, .note-as').addClass('on');
		}
		// C#
		...
		// D
			...
			$('.note-d').addClass('root');			
			$('.note-d, .note-e, .note-f, .note-g, .note-a, .note-as, .note-c').addClass('on');
		}
		// D#
			...
			$('.note-ds').addClass('root');			
			$('.note-ds, .note-f, .note-fs, .note-gs, .note-as, .note-b, .note-cs').addClass('on');
		}
		...
		// F
			...
			$('.note-f').addClass('root');
			$('.note-f, .note-g, .note-gs, .note-as, .note-c, .note-cs, .note-e').addClass('on');
		}
		// F#
		...
		// G
			...
			$('.note-g').addClass('root');
			$('.note-g, .note-a, .note-as, .note-c, .note-d, .note-ds, .note-fs').addClass('on');
		}
		// G#
			...
			$('.note-gs').addClass('root');				
			$('.note-gs, .note-as, .note-b, .note-cs, .note-ds, .note-e, .note-g').addClass('on');
		}
		// A
		...
		// Bb
			...
			$('.note-as').addClass('root');			
			$('.note-as, .note-c, .note-cs, .note-ds, .note-f, .note-fs, .note-a').addClass('on');
		}
		// B
		...
		// D
			...
			$('.note-d').addClass('root');			
			$('.note-d, .note-e, .note-f, .note-g, .note-a, .note-as, .note-cs').addClass('on');
		}
		// D#
			...
			$('.note-ds').addClass('root');			
			$('.note-ds, .note-f, .note-fs, .note-gs, .note-as, .note-b, .note-d').addClass('on');
		}
		...
		// F
			...
			$('.note-f').addClass('root');
			$('.note-f, .note-g, .note-a, .note-as, .note-c, .note-d, .note-ds').addClass('on');
		}
		// F#
		...
		// G#
			...
			$('.note-gs').addClass('root');				
			$('.note-gs, .note-as, .note-c, .note-cs, .note-ds, .note-f, .note-fs').addClass('on');
		}
		// A
		...
		// Bb
			...
			$('.note-as').addClass('root');			
			$('.note-as, .note-c, .note-d, .note-ds, .note-f, .note-g, .note-gs').addClass('on');
		}
		// B
		...
		// C
			...
			$('.note-c').addClass('root');		
			$('.note-c, .note-d, .note-e, .note-f, .note-g, .note-a, .note-as').addClass('on');
		}
		// C#
		else if (($('ul.select-root.mixolydian li.show-root-cs.active').length) && ($('ul.select-scale.cs li.scale-mixolydian.active').length)) {
			$('.note-cs').addClass('root');			
			$('.note-cs, .note-ds, .note-f, .note-fs, .note-gs, .note-as, .note-b').addClass('on');
		}
		// D
		...
		// D#
			...
			$('.note-ds').addClass('root');			
			$('.note-ds, .note-f, .note-g, .note-gs, .note-as, .note-c, .note-cs').addClass('on');
		}
		...
		// F
			...
			$('.note-f').addClass('root');
			$('.note-f, .note-g, .note-gs, .note-as, .note-c, .note-d, .note-ds').addClass('on');
		}
		// F#
		...
		// G
			...
			$('.note-g').addClass('root');
			$('.note-g, .note-a, .note-as, .note-c, .note-d, .note-e, .note-f').addClass('on');
		}
		// G#
		else if (($('ul.select-root.dorian li.show-root-gs.active').length) && ($('ul.select-scale.gs li.scale-dorian.active').length)) {
			$('.note-gs').addClass('root');				
			$('.note-gs, .note-as, .note-b, .note-cs, .note-ds, .note-f, .note-fs').addClass('on');
		}
		// A
		...
		// Bb
			...
			$('.note-as').addClass('root');			
			$('.note-as, .note-c, .note-cs, .note-ds, .note-f, .note-g, .note-gs').addClass('on');
		}
		// B
		...
		// C
			...
			$('.note-c').addClass('root');		
			$('.note-c, .note-d, .note-ds, .note-f, .note-g, .note-a, .note-as').addClass('on');
		}
		// C#
		else if (($('ul.select-root.dorian li.show-root-cs.active').length) && ($('ul.select-scale.cs li.scale-dorian.active').length)) {
			$('.note-cs').addClass('root');			
			$('.note-cs, .note-ds, .note-e, .note-fs, .note-gs, .note-as, .note-cs').addClass('on');
		}
		// D
		...
		// D#
			...
			$('.note-ds').addClass('root');			
			$('.note-ds, .note-f, .note-fs, .note-gs, .note-as, .note-c, .note-cs').addClass('on');
		}
